...
This script is used to train the MLP model for the LMMs expert,

BEFORE USING THIS SCRIPT
1. LMMs Context Features: must have been extracted using the prep_features_final.py script
...
def main():
    ...
    print(f"Training LMMS expert on {device}...")
